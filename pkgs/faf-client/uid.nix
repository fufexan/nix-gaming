...
stdenv.mkDerivation rec {
  ...
  postPatch = ''
    substituteInPlace uid.cpp --replace "const byte" "const uint8_t"
    substituteInPlace CMakeLists.txt --replace "set(CMAKE_EXE_LINKER_FLAGS" "# set(CMAKE_EXE_LINKER_FLAGS"
  '';
