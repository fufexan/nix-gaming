{
  ...
  versionStable = "2025.9.1";
  sha256Stable = "4h4hZkKLBrkNr+xLntMGkz+VYq7k9syXH4UVz6Lx2U4=";
  srcStable = fetchzip {
  ...
  versionUnstable = "2025.9.1-pioneer-beta-3";
  sha256Unstable = "Y0HT0rBGy7Ou4oPo8fxD0j5+Qgy5sQ/QHeBzVADu5/s=";
